...
const ScrollyTelling = () => {
  ...
  return (
    <div className="relative max-w-5xl mx-auto">
        ...
        <div className="sticky top-80 z-10 mt-60 mb-72 float-right">
      ...
      <Scrollama offset={0.5} onStepEnter={onStepEnter}>
        <Step data={0} key={0}>
          <div className="border-2 border-white">
            <Line y1={240} y2={1000} />
            <div className="w-1/2 flex shadow-xl mt-60 mb-72 ml-10 border-2 border-[#478778]">
              <p className="p-8 text-lg">
                Around 95% of Qatar&apos;s workforce is made up of migrant workers, mostly from the 
                Philippines and South Asia. In order to find jobs, many are forced to pay thousands 
          ...
          <div className="border-2 border-white">
            ...
            <div className="w-1/2 flex shadow-xl mt-60 mb-72 ml-10 border-2 border-[#478778]">
              <p className="p-8 text-lg">
                ...
                Many workers, fearing slow, taxing legal battles or employer retaliation, did not report the abuses. 
              </p>
            </div>
          </div>
        </Step>
