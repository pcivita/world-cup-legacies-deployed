...
export default function Footer () {
    return (
        <div className="flex flex-1 w-full shadow-inner py-10 bg-slate-50 font-medium text-slate-600">
            <div className="mx-auto w-full max-w-3xl items-center justify-between px-8 font-crimson">
                ...
                <div className="flex flex-row float-left my-4 text-xl">
                    <Link className="hover:text-black space-x-4 hover:scale-110 mr-3" href="/">Home</Link>
