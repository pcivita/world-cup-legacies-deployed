    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="max-w-3xl self-center">
        <p className="text-xl mb-10">
          When Brazil won the bid for the 2014 World Cup back in 2007, it was
          experiencing historic highs in its economy. With low inflation, lower
          inequality, and better living standards, the country was poised to
          become one of the key global players in the coming decades. And
          hosting the World Cup was the perfect way to demonstrate it...
        </p>

        <p className="text-xl mb-10">
          Spending an estimated 31.2 billion reais (around 6.3 billion dollars)
          in preparation for the event, it seemed that Brazil was, as the
          Economist put it back in 2009, “taking off”.
        </p>
        ...
        <p className="text-xl">
          ...
          consequences of the largest corruption scandal in the world, Brazil
          never took off as it expected. The legacy of the World Cup also
          mirrors the country&apos;s new reality. Instead of heralding a new
          era, the 2014 World Cup is mainly remembered in Brazil for its massive
          spending on infrastructure (Besides the 7x1). No other construction
          project captures that quite as well as the stadiums built and
          renovated in time for the event. With many still repaying their debts
          and some being completely underutilized, the stadiums are the most
          palpable reminder of Brazil&apos;s late 2000s optimism, and what came
          of it.
        </p>
      </div>
